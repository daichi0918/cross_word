...
// 値を渡すことができない場合処理が途中で止まる
    document.getElementById("level").textContent="初級　その弐";
    ...
    document.getElementById("one-value").textContent="C";
    document.getElementById("two-value").textContent="P";
    document.getElementById("three-value").textContent="U";
    document.getElementById("four-value").textContent="S";
    document.getElementById("five-value").textContent="　";
    document.getElementById("six-value").textContent="D";
    document.getElementById("seven-value").textContent="S";
    document.getElementById("eight-value").textContent="　";
    document.getElementById("nine-value").textContent="P";
